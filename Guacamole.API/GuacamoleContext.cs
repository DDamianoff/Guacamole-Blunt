...
namespace Guacamole.API
{
    public partial class GuacamoleContext : DbContext
    {
        public GuacamoleContext()
        {
        }

        public GuacamoleContext(DbContextOptions<GuacamoleContext> options)
            : base(options)
        {
        }
